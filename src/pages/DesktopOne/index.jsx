      ...
      <div className="bg-gray_50 flex font-inter items-center justify-end mx-[auto] w-[100%]">
        <div className="flex md:flex-col flex-row md:gap-[20px] items-start justify-start w-[100%]">
          <div className="h-[1086px] md:px-[20px] relative md:w-[100%] w-[7%]">
            <Sidebar className="absolute bg-bluegray_700 flex flex-col md:hidden inset-y-[0] justify-start left-[0] my-[auto] w-[63%]" />
            <div className="absolute bg-gray_50 flex items-start justify-start p-[10px] right-[0] rounded-[29px] top-[13%] w-[95%]">
              <div className="bg-deep_orange_300 h-[38px] md:ml-[0] ml-[6px] rounded-[50%] w-[38px]"></div>
            </div>
          </div>
          <div className="flex md:flex-1 flex-col items-center justify-start md:ml-[0] ml-[7px] md:mt-[0] mt-[47px] md:px-[20px] md:w-[100%] w-[57%]">
            ...
            <div className="bg-white_A700 flex md:flex-col flex-row md:gap-[20px] items-center justify-end mt-[53px] rounded-[12px] shadow-bs w-[100%]">
              <div className="flex md:flex-1 flex-row items-start justify-between md:w-[100%] w-[19%]">
                <div className="flex flex-col gap-[9px] items-center justify-start mt-[27px] w-[auto]">
                  <Img
                ...
                <Line className="bg-gray_400 h-[373px] shadow-bs1 w-[1px]" />
              </div>
              <div className="h-[373px] sm:h-[404px] md:h-[593px] relative md:w-[100%] w-[79%]">
                <div className="flex flex-col h-[100%] items-start justify-start ml-[33px] my-[auto] w-[87%]">
                  <div className="flex sm:flex-col flex-row sm:gap-[20px] items-center justify-start w-[100%]">
                    ...
                    <Text
                      className="font-light sm:ml-[0] ml-[205px] text-gray_700 text-left w-[auto]"
                      as="h5"
                      variant="h5"
                    >
                      Class & Section
                    ...
                    <Text
                      className="font-light sm:ml-[0] ml-[155px] text-gray_700 text-left w-[auto]"
                      as="h5"
                      variant="h5"
                    >
                      Class Roll No.
                  ...
                  <div className="flex md:flex-col flex-row md:gap-[20px] items-center justify-start mt-[4px] md:w-[100%] w-[89%]">
                    <Text
                    ...
                    <Text
                      className="font-normal md:ml-[0] ml-[251px] not-italic text-black_900 text-left w-[auto]"
                      as="h4"
                      variant="h4"
                    >
                      33
                  ...
                  <div className="flex md:flex-col flex-row md:gap-[20px] items-start justify-start mt-[35px] md:w-[100%] w-[99%]">
                    <Text
                      className="font-light text-gray_700 text-left w-[auto]"
                      as="h5"
                      variant="h5"
                    ...
                    <Text
                      className="font-light md:ml-[0] ml-[220px] text-gray_700 text-left w-[auto]"
                      as="h5"
                      variant="h5"
                    >
                      Admission No.
                    ...
                    <Text
                      className="font-light md:ml-[0] ml-[165px] text-gray_700 text-left w-[auto]"
                      as="h5"
                      variant="h5"
                    >
                      Blood Group
                  ...
                  <div className="flex md:flex-col flex-row md:gap-[20px] items-start justify-start mt-[3px] md:w-[100%] w-[89%]">
                    <Text
                    ...
                    <Text
                      className="font-normal mb-[2px] md:ml-[0] ml-[221px] not-italic text-black_900 text-left w-[auto]"
                      as="h4"
                      variant="h4"
                    >
                      A+
                  ...
                  <div className="flex flex-row items-center justify-between mt-[33px] md:w-[100%] w-[66%]">
                    <Text
                      className="font-light text-gray_700 text-left w-[auto]"
                      as="h5"
                      variant="h5"
                  ...
                  <div className="flex flex-row items-center justify-between mt-[4px] md:w-[100%] w-[65%]">
                    <Text
                      className="font-normal not-italic text-black_900 text-left w-[auto]"
                      as="h4"
                      variant="h4"
                ...
                <div className="absolute h-[373px] inset-[0] justify-center m-[auto] w-[100%]">
                  <div className="h-[373px] m-[auto] w-[100%]">
                    <Line className="absolute bg-gray_400 h-[373px] inset-y-[0] left-[39%] my-[auto] shadow-bs1 w-[1px]" />
                    <div className="absolute flex flex-col md:gap-[40px] gap-[90px] h-[max-content] inset-[0] items-center justify-center m-[auto] w-[100%]">
                      <Line className="bg-gray_400 h-[1px] rotate-[90deg] shadow-bs1 w-[100%]" />
                      <Line className="bg-gray_400 h-[1px] rotate-[90deg] shadow-bs1 w-[100%]" />
                      <Line className="bg-gray_400 h-[1px] rotate-[90deg] shadow-bs1 w-[100%]" />
                    </div>
                  </div>
                  <Line className="absolute bg-gray_400 h-[373px] inset-y-[0] my-[auto] right-[28%] shadow-bs1 w-[1px]" />
                </div>
              </div>
            </div>
            ...
            <div className="flex md:flex-col flex-row gap-[33px] items-center justify-between mt-[13px] w-[100%]">
              <div className="bg-white_A700 flex md:flex-1 items-start justify-end p-[28px] sm:px-[20px] rounded-[12px] shadow-bs md:w-[100%] w-[75%]">
                <div className="flex flex-col gap-[13px] items-center justify-start md:ml-[0] ml-[33px] mt-[28px] md:w-[100%] w-[81%]">
                  <div className="flex sm:flex-col flex-row sm:gap-[40px] items-start justify-between w-[100%]">
                    <Text
                      className="sm:mt-[0] mt-[60px] not-italic rotate-[90deg] text-gray_700 text-left w-[auto]"
                      variant="body3"
                    >
                      DAYS
                    </Text>
                    ...
                    <div className="md:h-[140px] h-[156px] relative sm:w-[100%] w-[87%]">
          ...
          <div className="flex md:flex-1 flex-col justify-start md:ml-[0] ml-[65px] md:px-[20px] md:w-[100%] w-[33%]">
            <div className="bg-bluegray_700 flex items-center justify-start p-[34px] sm:px-[20px] w-[100%]">
              <div className="flex flex-col gap-[53px] items-end justify-start mb-[22px] md:w-[100%] w-[90%]">
                ...
                <div className="flex flex-col items-start justify-start w-[100%]">
                  ...
                  <Text
                    className="font-semibold mt-[58px] text-gray_100 text-left w-[auto]"
                    as="h3"
                    variant="h3"
                  >
                    Timetable
                  ...
                  <Text
                    className="font-light md:ml-[0] ml-[4px] mt-[5px] text-bluegray_100 text-left w-[auto]"
                    as="h5"
                    variant="h5"
                  >
