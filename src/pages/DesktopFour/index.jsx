...
const DesktopFourPage = () => {
  return (
    <>
      <div className="bg-bluegray_900 flex font-inter items-center justify-end mx-[auto] w-[100%]">
        <div className="flex md:flex-col flex-row md:gap-[20px] items-start justify-start w-[100%]">
          <div className="h-[1086px] md:px-[20px] relative md:w-[100%] w-[7%]">
            <Sidebar className="absolute bg-bluegray_901 flex flex-col md:hidden inset-y-[0] justify-start left-[0] my-[auto] w-[63%]" />
            <div className="absolute bg-bluegray_900 flex items-start justify-end p-[8px] right-[0] rounded-[29px] top-[12%] w-[95%]">
              <div className="bg-red_A100 h-[38px] md:ml-[0] ml-[8px] mt-[4px] rounded-[50%] w-[38px]"></div>
            </div>
          </div>
          <div className="flex md:flex-1 flex-col items-center justify-start md:ml-[0] ml-[7px] md:mt-[0] mt-[47px] md:px-[20px] md:w-[100%] w-[57%]">
            <div className="flex sm:flex-col flex-row md:gap-[40px] items-end justify-between w-[100%]">
              <Text
                className="sm:mt-[0] mt-[8px] text-left text-white_A700 w-[auto]"
                as="h2"
                variant="h2"
              >
                Overview
              ...
              <Button
                className="bg-bluegray_901 cursor-pointer flex items-center justify-center min-w-[340px] pl-[20px] pr-[17px] py-[10px] rounded-[6px] w-[auto]"
                rightIcon={
              ...
              >
                <div className="font-normal leading-[normal] md:text-[20px] not-italic sm:text-[18px] text-[22px] text-left text-white_A700">
                  Academic Year 2020-2021
                </div>
              </Button>
            </div>
            <div className="bg-bluegray_901 flex items-center justify-end mt-[53px] p-[19px] rounded-[12px] shadow-bs w-[100%]">
              <div className="flex md:flex-col flex-row md:gap-[40px] items-start justify-between mt-[8px] md:w-[100%] w-[98%]">
                <div className="flex flex-col gap-[9px] items-center justify-start md:w-[100%] w-[12%]">
                  ...
                  />
                  <Text
                    className="font-light text-bluegray_101 text-left w-[auto]"
                    variant="body2"
                  >
                    Student Profile
                  </Text>
                ...
                <div className="flex flex-col items-start justify-start md:w-[100%] w-[77%]">
                  ...
                  <div className="flex md:flex-col flex-row md:gap-[20px] items-center justify-start mt-[4px] md:w-[100%] w-[90%]">
                    ...
                    <Text
                      className="font-normal md:ml-[0] ml-[226px] not-italic text-left text-white_A700 w-[auto]"
                      as="h4"
                      variant="h4"
                    >
                      2 A
                    ...
                    <Text
                      className="font-normal md:ml-[0] ml-[301px] not-italic text-left text-white_A700 w-[auto]"
                      as="h4"
                      variant="h4"
                    >
                      33
                  ...
                  <div className="flex md:flex-col flex-row md:gap-[20px] items-start justify-start mt-[3px] md:w-[100%] w-[90%]">
                    <Text
                      className="font-normal md:mt-[0] mt-[2px] not-italic text-left text-white_A700 w-[auto]"
                      as="h4"
                      variant="h4"
                    >
                      15 May 2010
                    ...
                    <Text
                      className="font-normal mb-[2px] md:ml-[0] ml-[196px] not-italic text-left text-white_A700 w-[auto]"
                      as="h4"
                      variant="h4"
                    >
                      10955
                    ...
                    <Text
                      className="font-normal mb-[2px] md:ml-[0] ml-[271px] not-italic text-left text-white_A700 w-[auto]"
                      as="h4"
                      variant="h4"
                    >
                      A+
                  ...
                  <Text
                    className="font-light mt-[36px] text-bluegray_101 text-left w-[auto]"
                    as="h5"
                    variant="h5"
                  >
                    Address
                  ...
                  <Text
                    className="font-normal mt-[6px] not-italic text-left text-white_A700 w-[auto]"
                    as="h4"
                    variant="h4"
                  >
            ...
            <div className="flex md:flex-col flex-row md:gap-[20px] items-center justify-start mt-[58px] w-[100%]">
              ...
              <Text
                className="font-semibold md:ml-[0] ml-[19px] text-left text-white_A700 w-[auto]"
                as="h3"
                variant="h3"
              >
                Attendance
              ...
              <Text
                className="font-light md:ml-[0] ml-[735px] text-left text-white_A700 w-[auto]"
                as="h3"
                variant="h3"
              >
                {"View Details >"}
            ...
            <div className="flex md:flex-col flex-row gap-[33px] items-center justify-between mt-[13px] w-[100%]">
              <div className="bg-bluegray_901 flex md:flex-1 items-start justify-end p-[28px] sm:px-[20px] rounded-[12px] shadow-bs md:w-[100%] w-[75%]">
                <div className="flex flex-col items-end justify-start md:ml-[0] ml-[41px] mt-[13px] md:w-[100%] w-[79%]">
                  <div className="flex sm:flex-col flex-row sm:gap-[20px] items-start justify-start w-[100%]">
                    <Text
                      className="sm:mt-[0] mt-[70px] not-italic rotate-[90deg] text-bluegray_102 text-left w-[auto]"
                      variant="body3"
                    >
                      DAYS
                    </Text>
                    <Text
                      className="font-normal sm:ml-[0] ml-[31px] sm:mt-[0] mt-[2px] not-italic text-left text-white_A700 w-[auto]"
                      as="h6"
                      variant="h6"
                    >
                      30
                    ...
                    <Img
                      ...
                      className="md:flex-1 h-[140px] sm:h-[auto] sm:ml-[0] ml-[9px] object-cover md:w-[100%] w-[auto]"
                      alt="groupOne"
                    />
                  </div>
                  <div className="flex sm:flex-col flex-row sm:gap-[20px] items-start justify-end ml-[auto] mt-[10px] md:w-[100%] w-[85%]">
                    <Text
                      className="font-normal not-italic text-left text-white_A700 w-[auto]"
                      as="h6"
                      variant="h6"
                    ...
                    <Text
                      className="font-normal sm:ml-[0] ml-[48px] not-italic text-left text-white_A700 w-[auto]"
                      as="h6"
                      variant="h6"
                    >
                      Feb
                    ...
                    <Text
                      className="font-normal sm:ml-[0] ml-[52px] not-italic text-left text-white_A700 w-[auto]"
                      as="h6"
                      variant="h6"
                    >
                      Mar
                    ...
                    <Text
                      className="font-normal sm:ml-[0] ml-[53px] not-italic text-left text-white_A700 w-[auto]"
                      as="h6"
                      variant="h6"
                    >
                      Apr
                    ...
                    <Text
                      className="font-normal sm:ml-[0] ml-[55px] not-italic text-left text-white_A700 w-[auto]"
                      as="h6"
                      variant="h6"
                    >
                      Aug
                  ...
                  <Text
                    className="mt-[12px] not-italic text-bluegray_102 text-left w-[auto]"
                    variant="body3"
                  >
                    MONTH
                  </Text>
              ...
              <div className="flex md:flex-1 flex-col gap-[30px] items-center justify-start md:w-[100%] w-[23%]">
                <div className="bg-bluegray_901 h-[120px] md:h-[74px] p-[21px] sm:px-[20px] relative rounded-[12px] shadow-bs w-[100%]">
                  <CircularProgressbar
                  ...
                  <Text
                    className="absolute font-inter font-normal left-[12%] not-italic text-bluegray_103 text-left top-[18%]"
                    as="h5"
                    variant="h5"
                  ></Text>
                  <Text
                    className="absolute bottom-[18%] font-inter font-normal left-[12%] not-italic text-left text-white_A700 w-[auto]"
                    variant="body2"
                  >
                    75/100 Classes
                  </Text>
                </div>
                <div className="bg-bluegray_901 flex items-start justify-end p-[21px] sm:px-[20px] rounded-[12px] shadow-bs w-[100%]">
                  <div className="flex flex-row gap-[15px] items-center justify-start md:ml-[0] ml-[8px] mr-[auto] md:w-[100%] w-[85%]">
                    <div className="flex flex-col font-inter gap-[20px] items-start justify-start w-[auto]">
                      <Text
                        className="font-medium text-bluegray_103 text-left"
                        as="h5"
                        variant="h5"
                      ></Text>
                      <Text
          ...
          <div className="flex md:flex-1 flex-col justify-start md:ml-[0] ml-[65px] md:px-[20px] md:w-[100%] w-[33%]">
            <div className="bg-bluegray_901 flex items-center justify-start p-[34px] sm:px-[20px] w-[100%]">
              <div className="flex flex-col gap-[53px] items-end justify-start mb-[22px] md:w-[100%] w-[90%]">
                ...
                <div className="flex flex-col items-start justify-start w-[100%]">
                  ...
                  <Text
                    className="font-semibold mt-[58px] text-left text-white_A700 w-[auto]"
                    as="h3"
                    variant="h3"
                  >
                    Timetable
                  ...
                  <Text
                    className="font-light md:ml-[0] ml-[4px] mt-[5px] text-left text-white_A700 w-[auto]"
                    as="h5"
                    variant="h5"
                  >
